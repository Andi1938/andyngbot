...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    displayText: 'By AndyGz',
                                    url: 'Wa.me/6282138899290'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
                                    phoneNumber: ' +62 821-3889-9290'
                                }
                            }, {
                                quickReplyButton: {
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://chat.whatsapp.com/Io6D75pvd2L9QLDVvu0YvQ'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Number Phone Owner',
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            kagura.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By DyrotBotz.mp3`}, { quoted : m })
            }
            break
...
case 'fiturlist': {
 {
                ...
                title: "CHANGE MENU BOT",
                rows: [
                {title: "Sc by andyGz", rowId: `owner`, description: `Myowner | Wa.me/6282138899290`},
...
`
                let btn = [{
                        ...
                        kagura.send5ButImg(m.chat, anu, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 AndyGZ`, global.thumb, btn)
                        } else if (setbot.templateGif) {
                        kagura.send5ButGif(m.chat, anu, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 AndyGZ`, global.visoka, btn)
                        } else if (setbot.templateVid) {
                        kagura.send5ButVid(m.chat, anu, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 AndyGZ`, global.visoka, btn)
                        } else if (setbot.templateMsg) {
                        kagura.send5ButMsg(m.chat, anu, `© 𝘊𝘳𝘦𝘢𝘵𝘦𝘥 𝘉𝘺 AndyGZ`, btn)
                        }
                     }
            break
            default:
